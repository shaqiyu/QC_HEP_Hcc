...
def Trandform(dataArray, dataArray2, rangConst="_0_1"):
    ...
    if rangConst == "_0_1":  # [0, 1]
        dataConstrain = (dataArray - np.min(dataArray, axis=0)) / np.ptp(
         ...
         dataConstrain2 = (2.*(dataArray2 - mini)/(maxi-mini))-1 #T1
    ...
    del dataArray, dataArray2
    return dataConstrain

def preparingData(confiFile="config_qqyy_8.json", prossEvent=100, removeNegativeWeight=True, fraction=0.5, seed=None, dataType="Classical"):
